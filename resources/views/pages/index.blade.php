...
@section('content')
    ...
    {{-- <div class="sticky flex flex-col justify-center w-full py-4 space-y-2">
        <a href="#slide1" class="btn btn-xs btn-circle bg-transparent border-base-300">1</a> 
        <a href="#slide2" class="btn btn-xs btn-circle bg-transparent border-base-300">2</a> 
    </div> --}}
    ...
    <div class="carousel carousel-vertical">
        ...
        <!-- Manual vs Automated -->
        <div id="slide-2" class="carousel-item hero min-h-screen bg-base-200">
            <div class="w-screen hero-content flex-row justify-evenly text-center px-20">
                <div class="max-w-md space-y-5">
                    <a href="#manual-testing-meme">
                        <h1 class="text-6xl font-bold">manual</h1>
                        <p>a human performs the tests step by step</p>
                    </a>
                </div>
                ...
                <div class="max-w-md space-y-5">
                    <a href="#automated-testing-meme">
                        <h1 class="text-6xl font-bold">automated</h1> 
                        <p>a testers utilize tools and scripts</p>
                    </a>
                </div>
            </div>

            <!-- Modals -->
            <div id="manual-testing-meme" class="modal">
                <div class="modal-box space-y-5">
                    <a href="{{ url('/#slide2') }}" class="btn btn-ghost float-right mb-3">
                        <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M12 11.293l10.293-10.293.707.707-10.293 10.293 10.293 10.293-.707.707-10.293-10.293-10.293 10.293-.707-.707 10.293-10.293-10.293-10.293.707-.707 10.293 10.293z"/></svg>
                    </a>
                    <video width="620" height="540" controls>
                        <source src="{{ asset('/videos/dev_vs_qa_meme.mp4') }}" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            </div>

            <div id="automated-testing-meme" class="modal">
                <div class="modal-box space-y-5">
                    <a href="{{ url('/#slide2') }}" class="btn btn-ghost float-right mb-3">
                        <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M12 11.293l10.293-10.293.707.707-10.293 10.293 10.293 10.293-.707.707-10.293-10.293-10.293 10.293-.707-.707 10.293-10.293-10.293-10.293.707-.707 10.293 10.293z"/></svg>
                    </a>
        ...
        <!-- Automated Testing -->
        <div id="slide-3" class="carousel-item hero min-h-screen bg-base-200">
            <div class="w-screen h-screen hero-content flex-col justify-start px-20 space-y-5">
                <div class="w-full text-left">
                    <h3 class="text-3xl font-bold mt-5">> types of automated testing</h3> 
                </div>
                <div class="w-full flex flex-row justify-evenly">
                    <div class="max-w-md space-y-5">
                        <div class="topic">
                            <h1 class="text-6xl font-bold">functional</h1>
                            <p>testing the application against the business requirements</p>
                        </div>
                            ...
                            <div class="card border border-base-content">
                                <a href="#unit-testing">
                                    <div class="card-body">
                                        ...
                                        <p>where individual units or components of a software are tested</p>
                                    </div>
                                </a>
                            </div> 
                            <div class="card border border-base-content">
                                <div class="card-body">
                                    ...
                                    <p>focuses mainly on the interfaces & flow of data/information between the modules</p>
                                </div>
                            </div> 
                        </div>
                    </div>
                    <div class="hidden divider lg:flex divider-vertical text-base-content text-opacity-30"></div>
                    <div class="max-w-md space-y-5">
                        <div class="topic">
                            <h1 class="text-6xl font-bold">non-functional</h1> 
                            <p>focused on the operational aspects of a piece of software</p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div class="card border border-base-content">
                                <div class="card-body">
                                    ...
                                    <p>evaluates the speed, responsiveness and stability of a software program under a workload</p>
                                </div>
                            </div> 
                            <div class="card border border-base-content">
                                <div class="card-body">
                                    <h2 class="card-title">security</h2> 
                                    <p>a process intended to reveal flaws in the security mechanisms of an information system</p>
                                </div>
                            </div> 
                        </div>
                    </div>
        ...
        <!-- Unit Testing > Jest -->
        <div id="slide-4" class="carousel-item hero min-h-screen bg-base-200">
